...
define(['template',
    ...
    function (template, $, homeTpl, common) {
        ...
        function createPage() {
            ...
            if (window.location.port == "58000") {
                $(".home-nav-li .teacask").attr("src","http://onlineweb.boxuegu.com/web/html/ansAndQus.html")
            } else {
                $(".home-nav-li .teacask").attr("src","http://boxuegu.com/web/html/ansAndQus.html")
            }
        ...
        //轮播图加载
        var banner = function () {
            return common.requestService('bxg_anon/home/banner', 'get', {});
        };


        //咨询公告
        var affiche = function () {
            return common.requestService('bxg_anon/home/affiche', 'get', {});
        };

        //精品课程
        var topCourse = function () {
            return common.requestService('bxg_anon/home/topCourse', 'get', {});
        };

        //教学扩展资源
        //var extendResource = function() {
        //	return common.requestService('bxg_anon/home/extendResource','get', {});
        //};

        var extendResource = function () {
            return common.requestService('bxg_anon/teachImprove/findByDownloadDesc', 'get', {});
        };

        //博问答---获取博问答数据
        var askAndAnswer = function () {
            return common.requestService('bxg_anon/home/askAndAnswer', 'get', {});
        };


        //合作院校模块
        var colleges = function () {
            return common.requestService('bxg_anon/home/colleges', 'get', {});
        };


        //我要合作接口
        var myJoin = function () {
            return common.requestService('bxg_anon/home/myJoin', 'get', {});
        };
