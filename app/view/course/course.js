define(['template',
		...
		'layer',
	    'laypage',
		'text!tplUrl/course/course.html',
		'text!tplUrl/course/course.module/course.item.html',
		'text!tplUrl/course/course.module/course.style.html',
		'common',
		'tplUrl/course/coursescript/course.script',
		'api',
		'css!cssUrl/course.lists'
],
	function (template,$,layui,layer,laypage,courseTpl,courseItemTpl,courseStyleTpl,common,script,api) {
		...
		function createPage(pagination,pagenumber) {
			...
			//课程导航
			common.ajaxRequest('bxg/course/categoryList', "GET", {}, function (data, state) {
		...
		var itemList = function(curr,sort,style,pagination){
			common.ajaxRequest('bxg/course/courseList', "POST", {
				pageNumber: curr || 1,//（当前是第几页）,
				pageSize: 15,//(每页显示多少记录)
				sort: sort || '', //（排序字段 ）
