...
define(['template',
        ...
        'layui',
        'layer',
        'text!tplUrl/teaching/taskmanage/FinishHomework/FinishHomework.html',
        'text!tplUrl/teaching/taskmanage/FinishHomework/FinishHomework.operation.html',
        'common',
        'api',
    ...
    function (template,$,layui,layer,
        ...
        function createPage(page,childpage,pagenumber) {
            ...
            $("#testcentresHtml").html(template.compile( FinishHomeworkTpl)({
            ...
            var table = $('#releasetaskTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'heat' },
                    { data: 'creationTime' },
                    { data: FinishHomeworkOperationTpl }
                ],
                ...
                "columnDefs": [
                    ...
                    { "width": "auto",className: "operation", "targets": 5 },
                    {
                        "targets": -1,
                        "data": null,
                        "defaultContent": FinishHomeworkOperationTpl
                    } ]
            });
