...
define(['template',
		...
		'layui',
		'layer',
		'text!tplUrl/teaching/review/review.html',
		'common',
		'api',
		'jquery.validate',
		'jquery.validate.zh',
	...
	function (template,$,layui,layer,
		...
		function createPage(page,childpage,pageType,reviewId) {
			...
			//处理子页面
			this.childCreatePage = function(page,childpage,pageType,reviewId){
				require( ['tplUrl/teaching/'+page+'/'+childpage+'/'+childpage], function (m) {
					m.createPage(page,childpage,pageType,reviewId);
				});
			}
